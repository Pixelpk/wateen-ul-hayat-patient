...
class SetNewPassword extends StatelessWidget {
  final String otp;
  SetNewPassword({required this.otp});
                              ...
                              cbtnElevatedButton(
                                onPressed: () {
                                  if (formGlobalKey.currentState!.validate()) {
                                    controller.hitUpdatePasswordAPI(password: controller.newPasswordController.text, otp: otp,context: context);
                                  }
                                },
